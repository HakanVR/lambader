...
<div class="bootstrap">
  ...
  <div class="footer-buttons">
    <button id="select_all_products"  class="btn btn-sm btn-default pull-left">{l s='Select all' mod='jxcategoryproducts'}</button>
    <button id="deselect_all_products"  class="btn btn-sm btn-default pull-left">{l s='Deselect all' mod='jxcategoryproducts'}</button>
    <button id="add_products"  class="btn btn-sm btn-default pull-right">{l s='Add' mod='jxcategoryproducts'}</button>
