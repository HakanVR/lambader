...
class JxHeaderAccountVKRegistrationModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        if (Customer::customerExists($email)) {
            ...
            if ($vk_id) {
                if ($vk_id == $user_id) {
                    Tools::redirect($this->context->link->getModuleLink('jxheaderaccount', 'vklogin', array(), false, $this->context->language->id));
                } else {
...
//                    $this->errors[] = Tools::displayError('an error occurred while linking your VK account.');
        ...
        $this->setTemplate('module:jxheaderaccount/views/templates/front/vkregistration.tpl');
    }
}
