...
class JxHeaderAccountVKLinkModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        if (!$this->context->customer->isLogged()) {
            $back = $this->context->link->getModuleLink('jxheaderaccount', 'vklink', array(), true, $this->context->language->id);
