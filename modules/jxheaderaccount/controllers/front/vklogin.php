...
class JxHeaderAccountVKLoginModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        $vkid = Configuration::get('JXHEADERACCOUNT_VKAPPID');
        $vkkey = Configuration::get('JXHEADERACCOUNT_VKAPPSECRET');
        $vk_redirect_url = Configuration::get('JXHEADERACCOUNT_VKREDIRECT');
        $vk_settings = 'email';

        $this->login_url = $this->context->link->getModuleLink('jxheaderaccount', 'vklogin', array(), true, $this->context->language->id);
        ...
        if (isset($access_token) && $access_token) {
            ...
            $this->setTemplate('module:jxheaderaccount/views/templates/front/vklogin.tpl');
        } else {
            Tools::redirect($vk->getAuthorizeURL($vk_settings, $vk_redirect_url));
        }
    }
