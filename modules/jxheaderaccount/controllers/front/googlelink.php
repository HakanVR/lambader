...
class JxHeaderAccountGoogleLinkModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        if (!$this->context->customer->isLogged()) {
            $back = $this->context->link->getModuleLink('jxheaderaccount', 'googlelink', array(), true, $this->context->language->id);
        ...
        $this->setTemplate('module:jxheaderaccount/views/templates/front/googlelink.tpl');
    }
}
