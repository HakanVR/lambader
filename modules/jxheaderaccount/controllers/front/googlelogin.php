...
class JxHeaderAccountGoogleLoginModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        $googleid = Configuration::get('JXHEADERACCOUNT_GAPPID');
        $googlekey = Configuration::get('JXHEADERACCOUNT_GAPPSECRET');
        $google_redirect_url = Configuration::get('JXHEADERACCOUNT_GREDIRECT');

        $this->login_url = $this->context->link->getModuleLink('jxheaderaccount', 'googlelogin', array(), true, $this->context->language->id);
        ...
        if ($g_client->getAccessToken()) {
            ...
            $this->setTemplate('module:jxheaderaccount/views/templates/front/googlelogin.tpl');
        } else {
