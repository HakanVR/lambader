...
class JxHeaderAccountFacebookLoginModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        if ($user_id) {
            ...
            $this->setTemplate('module:jxheaderaccount/views/templates/front/facebooklogin.tpl');
        } else {
