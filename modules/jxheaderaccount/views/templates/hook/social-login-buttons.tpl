...
{if $f_status}
  <a title="Login with your Facebook Account" class="button_large btn btn-login-facebook" {if isset($back) && $back}href="{$link->getModuleLink('jxheaderaccount', 'facebooklogin', ['back' => $back], true)}" {else}href="{$link->getModuleLink('jxheaderaccount', 'facebooklogin', [], true)}"{/if}>
