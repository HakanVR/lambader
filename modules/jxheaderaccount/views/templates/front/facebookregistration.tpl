  ...
  <nav class="breadcrumb hidden-sm-down">
    <ol itemscope itemtype="http://schema.org/BreadcrumbList">
      <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
        <a href="{$link->getPageLink('my-account', true)|escape:'htmlall':'UTF-8'}" title="{l s='Manage my account' mod='jxheaderaccount'}" rel="nofollow">{l s='My account' mod='jxheaderaccount'}</a>
      </li>
      <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
          <span>
            <span itemprop="name">{l s='Facebook registration' mod='jxheaderaccount'}</span>
          </span>
      </li>
    </ol>
  </nav>
{/block}
{block name="content"}
<form action="{$link->getModuleLink('jxheaderaccount', 'facebookregistration', array(), true)}" method="post" class="box">
  <div class="row">
    ...
    <div class="col-lg-6">
      ...
      <div class="form-group">
        ...
        <label class="radio-inline">
          <input type="radio" value="1" name="gender" {if $gender == 'male' || $gender == 1}checked{/if} />{l s='Male' mod='jxheaderaccount'}
        </label>
        <label class="radio-inline">
          <input type="radio" value="2" name="gender" {if $gender == 'famale' || $gender == 2}checked{/if} />{l s='Famale' mod='jxheaderaccount'}
        </label>
      </div>
      <div class="form-group">
