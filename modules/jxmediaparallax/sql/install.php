...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'jxmediaparallax` (
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'jxmediaparallax_lang` (
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'jxmediaparallax_layouts` (
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'jxmediaparallax_layouts_lang` (
