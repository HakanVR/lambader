...
<p class="buttons_bottom_block no-print">
  {if $wishlists|count == 1 || $wishlists|count == 0}
    <a href="#" id="wishlist_button_nopop" onclick="AddProductToWishlist('action_add', '{$id_product|intval}', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="{l s='Add to my wishlist' mod='jxwishlist'}">
      {l s='Add to wishlist' mod='jxwishlist'}
    </a>
  {else}
	<a id="wishlist_button" tabindex="0" data-toggle="popover" data-trigger="focus" title="{l s='Wishlist' mod='jxwishlist'}" data-placement="bottom">
	  {l s='Add to wishlist' mod='jxwishlist'}
	</a>
