...
class ClassJxWishlist extends ObjectModel
{
    ...
    /**
     * Delete products if exist id_wishlist
     * @param string $name
     * @return  results
     */
    ...
    /**
     * Return true if wishlists exists else false
    ...
    public static function getProductByIdWishlist($id_wishlist)
    {
        $products = Db::getInstance()->executeS(
            'SELECT jxwp.`id_wishlist`, jxwp.`id_product`, jxwp.`quantity`, p.`quantity` AS product_quantity, p.`price`, p.`show_price`, pl.`name`, jxwp.`id_product_attribute`, pl.link_rewrite
            FROM `'._DB_PREFIX_.'jxwishlist_product` jxwp
