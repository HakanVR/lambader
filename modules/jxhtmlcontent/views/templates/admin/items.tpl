...
{foreach name=langs from=$htmlitems.items key=lang item=langItems}
	...
	{foreach name=hooks from=$langItems key=hook item=hookItems}
		<h4 class="hook-title">{l s='Hook' mod='jxhtmlcontent'} "{$hook|escape:'htmlall':'UTF-8'}"</h4>
		{if $hookItems}
						...
						<form method="post" action="{$htmlitems.postAction|escape:'htmlall':'UTF-8'}" enctype="multipart/form-data" class="item-form defaultForm  form-horizontal">
							<div class="btn-group pull-right">
								<button class="btn btn-default button-edit">
									<span class="button-edit-edit"><i class="icon-edit"></i> {l s='Edit' mod='jxhtmlcontent'}</span>
									<span class="button-edit-close hide"><i class="icon-remove"></i> {l s='Close' mod='jxhtmlcontent'}</span>
								</button>
								...
								<ul class="dropdown-menu">
									<li>
										<a href="{$htmlitems.postAction|escape:'htmlall':'UTF-8'}&amp;removeItem&amp;item_id={$hItem.id_item|escape:'htmlall':'UTF-8'}" name="removeItem" class="link-item-delete">
											<i class="icon-trash"></i> {l s='Delete item' mod='jxhtmlcontent'}
										</a>
									</li>
								</ul>
							</div>
							...
							<div class="item-container clearfix">
								...
								<div class="title item-field form-group">
									<label class="control-label col-lg-3">{l s='Image title' mod='jxhtmlcontent'}</label>
									<div class="col-lg-7">
                                ...
                                <div class="title_use item-field form-group">
									<div class="col-lg-9 col-lg-offset-3">
										<div class="checkbox">
											<label class="control-label">
												{l s='Use title in front' mod='jxhtmlcontent'}
								...
								<div class="hook item-field form-group">
									<label class="control-label col-lg-3">{l s='Hook to which the image should be attached' mod='jxhtmlcontent'}</label>
									<div class="col-lg-7">
										<select name="item_hook" default="home" class="fixed-width-lg">
                                       		<option value="displayNav1"{if $hItem.hook == 'displayNav1'} selected="selected"{/if}>nav</option>
								...
								<div class="specific_class item-field form-group">
									<label class="control-label col-lg-3 ">{l s='Specific class' mod='jxhtmlcontent'}</label>
									<div class="col-lg-2">
								...
								<div class="image item-field form-group">
									<label class="control-label col-lg-3">{l s='Load your image' mod='jxhtmlcontent'}</label>
									<div class="col-lg-7">
										<input type="file" name="item_img" />
									</div>
								</div>
								<div class="image_w item-field form-group">
									<label class="control-label col-lg-3">{l s='Image width' mod='jxhtmlcontent'}</label>
									<div class="col-lg-7">
								...
								<div class="image_h item-field form-group">
									<label class="control-label col-lg-3">{l s='Image height' mod='jxhtmlcontent'}</label>
									<div class="col-lg-7">
										<div class="input-group fixed-width-lg">
								...
								<div class="url item-field form-group">
									<label class="control-label col-lg-3">{l s='Target link' mod='jxhtmlcontent'}</label>
									<div class="col-lg-7">
								...
								<div class="target item-field form-group">
									<div class="col-lg-9 col-lg-offset-3">
										<div class="checkbox">
											<label class="control-label">
												{l s='Open link in a new tab/page' mod='jxhtmlcontent'}
								...
								<div class="html item-field form-group">
									<label class="control-label col-lg-3">{l s='Optional HTML code' mod='jxhtmlcontent'}</label>
									<div class="col-lg-7">
								...
								<div class="form-group">
									<div class="col-lg-7 col-lg-offset-3">
										<button type="button" class="btn btn-default button-item-edit-cancel" >
											<i class="icon-remove"></i> {l s='Cancel' mod='jxhtmlcontent'}
										</button>
										<button type="submit" name="updateItem" class="btn btn-success button-save pull-right" >
											<i class="icon-save"></i> {l s='Save' mod='jxhtmlcontent'}
										</button>
									</div>
								</div>
							</div>
		...
		{else}
			<div class="item">
				<span class="text-muted">{l s='No items available' mod='jxhtmlcontent'}</span>
			</div>
		{/if}
	{/foreach}
	</div>
