...
<div class="new-item">
	<div class="form-group">
		<button type="button" class="btn btn-default btn-lg button-new-item"><i class="icon-plus-sign"></i> {l s='Add item' mod='jxhtmlcontent'}</button>
	</div>
		...
		<form method="post" action="{$htmlitems.postAction|escape:'htmlall':'UTF-8'}" enctype="multipart/form-data" class="item-form defaultForm  form-horizontal">
			<div class="well">
				<div class="language item-field form-group">
					<label class="control-label col-lg-3">{l s='Language' mod='jxhtmlcontent'}</label>
					<div class="col-lg-7">
				...
				<div class="title item-field form-group">
					<label class="control-label col-lg-3 ">{l s='Title' mod='jxhtmlcontent'}</label>
					<div class="col-lg-7">
				...
				<div class="hook item-field form-group">
					<label class="control-label col-lg-3">{l s='Hook' mod='jxhtmlcontent'}</label>
					<div class="col-lg-7">
				...
				<div class="image item-field form-group">
					<label class="control-label col-lg-3">{l s='Image' mod='jxhtmlcontent'}</label>
					<div class="col-lg-7">
				...
				<div class="url item-field form-group">
					<label class="control-label col-lg-3">{l s='URL' mod='jxhtmlcontent'}</label>
					<div class="col-lg-7">
				...
				<div class="target item-field form-group">
					<div class="col-lg-9 col-lg-offset-3">
						<div class="checkbox">
							<label class="control-label">
								{l s='Target blank' mod='jxhtmlcontent'}
				...
				<div class="html item-field form-group">
					<label class="control-label col-lg-3">{l s='HTML' mod='jxhtmlcontent'}</label>
					<div class="col-lg-7">
				...
				<div class="form-group">
					<div class="col-lg-7 col-lg-offset-3">
						<button type="button" class="btn btn-default button-new-item-cancel"><i class="icon-remove"></i> {l s='Cancel' mod='jxhtmlcontent'}</button>
						<button type="submit" name="newItem" class="btn btn-success button-save pull-right"><i class="icon-save"></i> {l s='Save' mod='jxhtmlcontent'}</button>
					</div>
				</div>
			</div>
		</form>
