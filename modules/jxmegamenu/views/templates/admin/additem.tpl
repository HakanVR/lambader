  ...
  <div class="panel jxmegamenu">
    ...
    <div class="form-wrapper">
      <div class="form-group">
        <label class="control-label col-lg-3 text-right required"> {l s='Enter item name' mod='jxmegamenu'}</label>
      ...
      <div class="form-group">
        <label class="col-lg-3 control-label">{l s='Active' mod='jxmegamenu'}</label>
        <div class="col-lg-9">
          <span class="switch prestashop-switch fixed-width-lg">
              ...
              <label for="addnewactive_on" class="radioCheck">
                <i class="color_success"></i> {l s='Yes' mod='jxmegamenu'}
              </label>
              ...
              <label for="addnewactive_off" class="radioCheck">
                <i class="color_danger"></i> {l s='No' mod='jxmegamenu'}
              </label>
      ...
      <div class="form-group">
        <label class="control-label col-lg-3 text-right">{l s='Link' mod='jxmegamenu'}</label>
        <div class="col-lg-2">
          <select id="jxmegamenu_url_type" name="tab_url_type">
      ...
      <div class="form-group jxmegamenu_url_text">
        ...
        {else}
          {assign var='active' value=''}
        {/if}
        <div class="jxmegamenu-fields-url" style="display:none;">
          {foreach from=$languages item=language}
            {if isset($item) && $item}
            ...
            <div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}">
              <div class="col-lg-2">
                <input type="text" id="url_{$language.id_lang|escape:'htmlall':'UTF-8'}" class="tagify CurrentText" name="tab_url_{$language.id_lang|escape:'htmlall':'UTF-8'}" placeholder="{l s='Custom Url' mod='jxmegamenu'}" value="{if isset($item) && $item && $item.is_custom_url && isset($item.$url_text)}{$item.$url_text|escape:'htmlall':'UTF-8'}{/if}"/>
              </div>
              <div class="col-lg-1">
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                  {$language.iso_code|escape:'htmlall':'UTF-8'}
        ...
        <div class="col-lg-2">
          <select name="tab_url" style="display:none;">
            <option disabled="disabled">{l s='Categories' mod='jxmegamenu'}</option>
            {foreach from=$categTree.children item=child name=categTree}
              {include file="$branche_tpl_path" node=$child active=$active}
            {/foreach}
            <option disabled="disabled">{l s='Cms Categories' mod='jxmegamenu'}</option>
      ...
      <div class="selector item-field form-group">
        <label class="control-label col-lg-3">{l s='Sort order' mod='jxmegamenu'}</label>
        <div class="col-lg-1">
          <input type="text" name="sort_order" value="{if isset($item) && $item}{$item.sort_order|escape:'htmlall':'UTF-8'}{/if}">
        </div>
      </div>
      <div class="item-field form-group">
        <label class="control-label col-lg-3">{l s='Specific class' mod='jxmegamenu'}</label>
        <div class="col-lg-2">
          <input type="text" name="specific_class" value="{if isset($item) && $item}{$item.specific_class|escape:'htmlall':'UTF-8'}{/if}">
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-lg-3 text-right"> {l s='Enter item badge' mod='jxmegamenu'}</label>
        {foreach from=$languages item=language}
          {if isset($item) && $item}
      ...
      <div id="is_mega_menu" class="form-group">
        <label class="col-lg-3 control-label">{l s='It is Mega Menu' mod='jxmegamenu'}</label>
        <div class="col-lg-9">
          <span class="switch prestashop-switch fixed-width-lg">
      ...
      <div id="is_simple_menu" class="form-group">
        <label class="col-lg-3 control-label">{l s='Use simple menu' mod='jxmegamenu'}</label>
        <div class="col-lg-9">
        <span class="switch prestashop-switch fixed-width-lg">
      ...
      <div class="simple_menu">
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <div class="row">
              <div class="col-lg-4">
                <h4>{l s='Available items' mod='jxmegamenu'}</h4>
                <div class="form-group">
                  {$option_select}
                </div>
                <button id="addItem" class="btn btn-default">{l s='Add' mod='jxmegamenu'} -></button>
              </div>
              <div class="col-lg-1 order-buttons">
                <button id="menuOrderUp" class="btn btn-default btn-block">{l s='Up' mod='jxmegamenu'}</button>
                <button id="menuOrderDown" class="btn btn-default btn-block">{l s='Down' mod='jxmegamenu'}</button>
              </div>
              <div class="col-lg-4">
                <h4>{l s='Selected items' mod='jxmegamenu'}</h4>
                <div class="form-group">
                  {$option_selected}
                </div>
                <button id="removeItem" class="btn btn-default"><- {l s='Remove' mod='jxmegamenu'}</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="mega_menu">
        {if !isset($item)}
          <p class="alert alert-info text-left">{l s='Auto save will be available after item\'s first saving.' mod='jxmegamenu'}</p>{/if}
        <div id="megamenu-content">
          {if isset($megamenu) && $megamenu}{$megamenu}{/if}
        </div>
        <a class="btn btn-sm btn-default" id="add-megamenu-row" href="#" onclick="return false;">{l s='Add row' mod='jxmegamenu'}</a>
    ...
    <div class="panel-footer">
      <button type="submit" name="updateItem" class="button-new-item-save btn btn-default pull-right">
        <i class="process-icon-save"></i> {l s='Save' mod='jxmegamenu'}</button>
      <button type="submit" name="updateItemStay" class="button-new-item-save-stay btn btn-default pull-right">
        <i class="process-icon-save"></i> {l s='Save & Stay' mod='jxmegamenu'}</button>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">{l s='Item Styles' mod='jxmegamenu'}</h4>
      </div>
        ...
        {if isset($item) && $item && $item.unique_code}
          <div class="form-wrapper">
            <form id="jxmegamenu-style" class="form-horizontal" action="" method="post">
              ...
              <fieldset>
                <h4>{l s='Top level element' mod='jxmegamenu'} <span>{l s='(hover & active)' mod='jxmegamenu'}</span>
                </h4>
                <div class="fieldset-content-wrapper closed">
                  ...
                  <input type="hidden" class="classes" value="{$item.unique_code|escape:'html':'UTF-8'}.top-level-menu-li.sfHover, .{$item.unique_code|escape:'html':'UTF-8'}.jxmegamenu_item.top-level-menu-li.sfHoverForce"/>
                </div>
              </fieldset>
              <fieldset>
              ...
              <fieldset>
                <h4>{l s='Top level element link' mod='jxmegamenu'}
                ...
                <div class="fieldset-content-wrapper closed">
                  ...
                  <input type="hidden" class="classes" value="{$item.unique_code|escape:'html':'UTF-8'}.top-level-menu-li.sfHover > a, .{$item.unique_code|escape:'html':'UTF-8'}.jxmegamenu_item.top-level-menu-li.sfHoverForce > a"/>
                </div>
              </fieldset>
              <fieldset>
                ...
                <div class="fieldset-content-wrapper closed">
                  ...
                  <input type="hidden" class="classes" value="top_menu > ul > li.{$item.unique_code|escape:'html':'UTF-8'} ul.is-simplemenu, .jxmegamenu_item.top_menu > ul > li.{$item.unique_code|escape:'html':'UTF-8'} ul.is-simplemenu ul, .jxmegamenu_item.column_menu > ul > li.{$item.unique_code|escape:'html':'UTF-8'} ul.is-simplemenu, .jxmegamenu_item.column_menu > ul > li.{$item.unique_code|escape:'html':'UTF-8'} ul.is-simplemenu ul"/>
                </div>
              </fieldset>
              <fieldset>
                ...
                <div class="fieldset-content-wrapper closed">
                  ...
                  <input type="hidden" class="classes" value="top_menu li.{$item.unique_code|escape:'html':'UTF-8'} li, .jxmegamenu_item.column_menu li.{$item.unique_code|escape:'html':'UTF-8'} li"/>
                </div>
              </fieldset>
              <fieldset>
                ...
                <div class="fieldset-content-wrapper closed">
                  ...
                  <input type="hidden" class="classes" value="top_menu li.{$item.unique_code|escape:'html':'UTF-8'} li a, .jxmegamenu_item.column_menu li.{$item.unique_code|escape:'html':'UTF-8'} li a"/>
                </div>
              </fieldset>
              <fieldset>
                ...
                <div class="fieldset-content-wrapper closed">
                  ...
                  <input type="hidden" class="classes" value="top_menu li.{$item.unique_code|escape:'html':'UTF-8'} li.sfHover > a, .jxmegamenu_item.top_menu li.{$item.unique_code|escape:'html':'UTF-8'} li:hover > a, .jxmegamenu_item.top_menu li.{$item.unique_code|escape:'html':'UTF-8'} li.sfHoverForce > a, .jxmegamenu_item.column_menu li.{$item.unique_code|escape:'html':'UTF-8'} li.sfHover > a, .jxmegamenu_item.column_menu li.{$item.unique_code|escape:'html':'UTF-8'} li:hover > a, .jxmegamenu_item.column_menu li.{$item.unique_code|escape:'html':'UTF-8'} li.sfHoverForce > a"/>
                </div>
              </fieldset>
              <fieldset>
                ...
                <div class="fieldset-content-wrapper closed">
                  ...
                  <input type="hidden" class="classes" value="top_menu > ul > li.{$item.unique_code|escape:'html':'UTF-8'} ul.is-simplemenu ul, .jxmegamenu_item.column_menu > ul > li.{$item.unique_code|escape:'html':'UTF-8'} ul.is-simplemenu ul"/>
                </div>
              </fieldset>
              <fieldset>
                ...
                <div class="fieldset-content-wrapper closed">
                  ...
                  <input type="hidden" class="classes" value="top_menu li.{$item.unique_code|escape:'html':'UTF-8'} li li, .jxmegamenu_item.column_menu li.{$item.unique_code|escape:'html':'UTF-8'} li li"/>
                </div>
              </fieldset>
              <fieldset>
                ...
                <div class="fieldset-content-wrapper closed">
                  ...
                  <input type="hidden" class="classes" value="top_menu li.{$item.unique_code|escape:'html':'UTF-8'} li li a, .jxmegamenu_item.column_menu li.{$item.unique_code|escape:'html':'UTF-8'} li li a"/>
                </div>
              </fieldset>
              <fieldset>
                <h4>{l s='Next level element link' mod='jxmegamenu'}
                  <span>{l s='(hover & active)' mod='jxmegamenu'}</span></h4>
                <div class="fieldset-content-wrapper closed">
                  <div class="form-group">
                    <label class="control-label col-lg-2">{l s='Color' mod='jxmegamenu'}</label>
                  ...
                  <input type="hidden" class="classes" value="top_menu li.{$item.unique_code|escape:'html':'UTF-8'} li li.sfHover > a, .jxmegamenu_item.top_menu li.{$item.unique_code|escape:'html':'UTF-8'} li li:hover > a, .jxmegamenu_item.top_menu li.{$item.unique_code|escape:'html':'UTF-8'} li li.sfHoverForce > a, .jxmegamenu_item.column_menu li.{$item.unique_code|escape:'html':'UTF-8'} li li.sfHover > a, .jxmegamenu_item.column_menu li.{$item.unique_code|escape:'html':'UTF-8'} li li:hover > a, .jxmegamenu_item.column_menu li.{$item.unique_code|escape:'html':'UTF-8'} li li.sfHoverForce > a"/>
                </div>
              </fieldset>
            </form>
          </div>
        {else}
          <p class="alert alert-warning">{l s='You should save this item before styles changing' mod='jxmegamenu'}</p>
        {/if}
      </div>
      <div class="modal-footer">
        <button id="generate-styles" class="btn btn-sm btn-success" {if !isset($item)}disabled="disabled"{/if}>{l s='Generate styles' mod='jxmegamenu'}</button>
        <button id="reset-styles" class="btn btn-sm btn-danger pull-left" {if !isset($item)}disabled="disabled"{/if}>{l s='Reset styles' mod='jxmegamenu'}</button>
...
<script type="text/javascript">
  ...
  var product_add_text = '{l s='Indicate the ID number for the product' mod='jxmegamenu'}';
  var product_id = '{l s='Product ID #' mod='jxmegamenu'}';
  var move_warning = '{l s='Please select just one item' mod='jxmegamenu'}';
  var add_megamenu_column = '{l s='Add column' mod='jxmegamenu'}';
  var col_width_label = '{l s='Set column width' mod='jxmegamenu'}';
  var col_width_text = '{l s='Set column width (2 min -> 12 max)' mod='jxmegamenu'}';
  var col_width_alert_min_text = '{l s='Column width can not be less than 2' mod='jxmegamenu'}';
  var col_width_alert_max_text = '{l s='Column width can not be  less than 2 and more than 12' mod='jxmegamenu'}';
  var col_items_text = '{l s='Set content' mod='jxmegamenu'}';
  var col_items_selected_text = '{l s='Selected item' mod='jxmegamenu'}';
  var col_class_text = '{l s='Enter specific class' mod='jxmegamenu'}';
  var col_content_type_text = '{l s='Content type' mod='jxmegamenu'}';
  var col_html_text = '{l s='HTML' mod='jxmegamenu'}';
  var col_links_text = '{l s='Links' mod='jxmegamenu'}';
  var add_col_content_text = '{l s='Add content' mod='jxmegamenu'}';
  var error_type_text = '{l s='Please select column content type!' mod='jxmegamenu'}';
  var btn_add_text = '{l s='Add' mod='jxmegamenu'}';
  var btn_remove_text = '{l s='Remove' mod='jxmegamenu'}';
  var btn_remove_column_text = '{l s='Remove block' mod='jxmegamenu'}';
  var btn_remove_row_text = '{l s='Remove row' mod='jxmegamenu'}';
  var warning_class_text = '{l s='Can not contain special chars, only _ is allowed.(Will be automatically replaced)' mod='jxmegamenu'}';
