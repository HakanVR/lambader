...
$(document).ready(function() {
	var idArray = [],
	click_scroll = false;
	$('#jxhomepagecategorygallery-nav a').each(function(index){
		idArray[index]=$(this).attr('href');
	});

	$('#jxhomepagecategorygallery-nav a').click(function(){
		click_scroll = true;
		link = $(this)
...
{
	if (!$('.jxhomepagecategorygallery-block').length)
		return;
	allElementHeight = 0;
	fromBlockToTop = $('.jxhomepagecategorygallery-block').offset().top;
	elementHeight = $('#jxhomepagecategorygallery > li').outerHeight();
	paginationHeight =  $('#jxhomepagecategorygallery-nav').outerHeight();

	$('#jxhomepagecategorygallery > li').each(function() {
	...
	$('#jxhomepagecategorygallery-nav').css('marginTop', marginTop);
}