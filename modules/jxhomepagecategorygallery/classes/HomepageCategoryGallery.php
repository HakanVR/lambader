...
class HomepageCategoryGalleryItem extends ObjectModel
{
    ...
    public static $definition = array(
        'table'     => 'jxhomepagecategorygallery',
        'primary'   => 'id_item',
        'multilang' => true,
        'fields'    => array(
    ...
    public function add($autodate = true, $null_values = false)
    {
        ...
        $res &= Db::getInstance()->execute(
            'INSERT INTO `'._DB_PREFIX_.'jxhomepagecategorygallery_shop` (`id_item`, `id_shop`)
    ...
    public function delete()
    {
        ...
        $res &= Db::getInstance()->execute(
            'DELETE FROM `'._DB_PREFIX_.'jxhomepagecategorygallery_shop`
