...
{block name='content'}
  <section id="main" itemscope itemtype="https://schema.org/Product">
                ...
                {block name='product_pack'}
                  {if $packItems}
                    <section class="product-pack">
                      ...
                      <div class="product-carousel-pack">
        ...
        <div class="tabs">
          ...
          <div class="tab-content" id="tab-content">
            ...
            {block name='product_attachments'}
              {if $product.attachments}
                <h3 class="h6 hidden-md-up">{l s='Attachments' d='Shop.Theme.Catalog'}</h3>
    ...
    {block name='product_accessories'}
      {if $accessories}
        <section class="product-carousel product-accessories clearfix mb-6">
          <h3 class="text-center products-section-title">{l s='You might also like' d='Shop.Theme.Catalog'}</h3>
