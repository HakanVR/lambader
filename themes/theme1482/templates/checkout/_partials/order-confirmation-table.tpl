...
<div id="order-items" class="col-md-12">
  ...
  {block name='order_items_table_head'}
    <h3 class="card-title h4">{l s='Order items' d='Shop.Theme.Checkout'}</h3>
  {/block}
    ...
    {block name='order_confirmation_table'}
      ...
      <table>
        ...
        <tr class="font-weight-bold">
          <td><span class="text-uppercase text-dark">{$totals.total.label}</span> {$labels.tax_short}</td>
          <td class="text-dark">{$totals.total.value}</td>
        </tr>
      </table>
    {/block}
