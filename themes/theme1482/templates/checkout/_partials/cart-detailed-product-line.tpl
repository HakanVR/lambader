...
<div class="product-line-grid row">
  <!--  product left content: image-->
    ...
    <div class="product-line-grid-left col-md-3 col-12">
    ...
    <div class="product-line-grid-body col-md-4 col-12">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-10 col-9">
          <div class="row align-items-center">
            ...
            <div class="col-md-5 col-5 price">
        ...
        <div class="col-md-2 col-3 text-xs-right">
