...
<p class="buttons_bottom_block no-print">
    ...
    <a href="#" class="wishlist_button_nopop AddToWishlist" onclick="AddProductToWishlist('action_add', '{$product.id_product|intval}', '{Product::getDefaultAttribute($product.id_product)}', 1); return false;" rel="nofollow"  title="{l s='Add to my wishlist' mod='jxwishlist'}">
      <i class="material-icons">&#xe87e;</i>
    </a>
    {else}
    <a class="wishlist_button AddToWishlist" tabindex="0" data-toggle="popover" data-trigger="focus" title="{l s='Wishlist' mod='jxwishlist'}" data-placement="bottom">
      <i class="material-icons">&#xe87e;</i>
    </a>
